...
const GPTSearch = () => {
  ...
  return (
    <div className="absolute  w-full h-screen overflow-hidden">
      ...
      <div className="relative mx-[21px] mr-[21px] mt-[20px] smartphone:mt-[40px] tablet:mt-[60px] laptop:mt-[80px] desktop:mt-[100px]">
      ...
      <div className="relative flex flex-wrap w-screen h-[580px] justify-center items-center overflow-y-scroll gap-5 mt-5 mb-24 no-scrollbar">
        {movielist.map((movie) => {
