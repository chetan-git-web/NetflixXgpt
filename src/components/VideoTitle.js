...
const VideoTitle = ({ title, text , id}) => {
  console.log(id);
  return (
    <div className=' px-12 absolute bg-gradient-to-r from-black w-full aspect-video pt-[12rem]' >
      ...
      <Link to={"/content/"+id}><button className='bg-white flex font-semibold p-6 rounded-md w-[6rem] h-[3rem] justify-center items-center hover:opacity-50'><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24
        " fill="currentColor" className="bi bi-play" viewBox="0 0 16 16"> <path d="M10.804 8 5 4.633v6.734L10.804 8zm.792-.696a.802.802 0 0 1 0 1.392l-6.363 3.692C4.713 12.69 4 12.345 4 11.692V4.308c0-.653.713-.998 1.233-.696l6.363 3.692z" /> </svg><h1>Play</h1></button></Link>
