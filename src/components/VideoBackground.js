...
const VideoBackground = ({ id, image }) => {
  ...
  return (
    ...
    <iframe className=' w-screen aspect-video'  src={"https://www.youtube.com/embed/"+movie+"?si=COyO53XZKiQSrQ19&amp;controls=0&amp;start=20&mute=1&autoplay=1&loop=1&showinfo=0"}  frameBorder="0" allow="accelerometer " allowFullScreen></iframe>
